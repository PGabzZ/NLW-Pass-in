            ...
            <div className='border border-white/10 rounded-lg'>
                <table className='w-full'>
                    ...
                    <tbody>
                        ...
                        return(
                            <tr key={1} className='border-b border-white/10'>
                                <td className='py-3 px-4 text-sm text-zinc-300'>
                                    <input type='checkbox' className='size-4 bg-black/20 rounded border-white/10'/>
                                </td>
                                <td className='py-3 px-4 text-sm text-zinc-300'>45644</td>
                                <td className='py-3 px-4 text-sm text-zinc-300'>
                                    <div className='flex flex-col gap-1'>
                                        <span className='font-semibold text-white'> Gabriel Picolo</span>
                                        <span>gabriel@gmail.com</span>
                                    </div>
                                </td>
                    ...
                    <tfoot>
                        <tr>
                            <td className='py-3 px-2 text-sm text-zinc-300 text-left' colSpan={3}> 
                            Mostrando 10 de 28 itens
                            </td>
                            <td className='py-3 px-2 text-sm text-zinc-300 text-right' colSpan={3}>
                                <div className='inline-flex items-center gap-8'>
                                    <span>Página 1 de 3</span>
                                    <div className='flex gap-1.5'>
                                        <button className='bg-white/10 border border-white/10 rounded-md px-1.5 p-1.5'>
